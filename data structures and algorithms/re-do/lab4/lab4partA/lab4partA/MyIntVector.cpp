...
//LAB 4A
//code samples gotten from https://www.geeksforgeeks.org/copy-constructor-in-cpp/
//code samples gotten from https://learn.microsoft.com/en-us/cpp/standard-library/overloading-the-output-operator-for-your-own-classes?view=msvc-170
...
{
	str << myVec.m_size << '/' << myVec.m_capacity << '/' << myVec.arrPtr;
	return str;
}
